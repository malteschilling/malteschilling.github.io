...
\pagestyle{empty}
  \begin{tikzpicture}
    ...
    % Second from top row.
    \draw[stealth-stealth, line width=0.4mm] (6.15, 4.5) -- (6.85, 2.5);
    \draw[stealth-stealth, line width=0.4mm] (6.5, 4.15) -- (6.5, 2.85);
    \draw[stealth-stealth, line width=0.4mm] (7.15, 4.5) -- (7.85, 2.5);
    \draw[stealth-stealth, line width=0.4mm] (7.5, 4.15) -- (7.5, 2.85);
    \draw[stealth-stealth, line width=0.4mm] (8.15, 4.5) -- (8.85, 2.5);
    \draw[stealth-stealth, line width=0.4mm] (8.5, 4.15) -- (8.5, 2.85);
    % Second from bottom row.
    \draw[stealth-stealth, line width=0.4mm] (6.15, 3.5) -- (6.85, 3.5);
    \draw[stealth-stealth, line width=0.4mm] (6.5, 3.15) -- (6.5, 3.85);
    \draw[stealth-stealth, line width=0.4mm] (7.15, 3.5) -- (7.85, 3.5);
