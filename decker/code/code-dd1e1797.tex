...
\pagestyle{empty}
  \begin{tikzpicture}
    ...
    \node[draw,circle,scale=2/3] (left_up) at (-1.5, 1.5) {\scriptsize A};
    \node[draw,circle,scale=2/3] (b) at (-1.5, 0) {\scriptsize I};
    ...
    \draw[-stealth]  (left_up) -- (l);
    \draw[stealth-stealth, dashed] (left_up) -- (b);
