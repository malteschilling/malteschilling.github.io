...
\pagestyle{empty}
  \begin{tikzpicture}
    ...
    \node at (6, 0.5) {The Cliff};
    \node (beg) at (0.5, 0.5) {S};
    \node (end) at (11.5, 0.5) {G};
    \path[draw,purple,thick,->] (0.75, 0.5) -- (0.75, 1.5) -- (11.25, 1.5) -- (11.25, 0.5);
    \path[draw,orange,thick,->] (0.25, 0.5) -- (0.25, 3.5) -- (11.75, 3.5) --     (11.75, 0.5);
\node at (-1.5, 1.25) {\color{purple} Optimal path};
