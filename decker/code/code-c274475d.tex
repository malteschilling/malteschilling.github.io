...
\node[font=\sffamily] at (-1.3,-0.3) {\small\color{red}Value Based};
\node[font=\sffamily] at (0.,0.) {\color{blue}Policy};
\node[font=\sffamily] at (1.3,-0.3) {\small\color{red}Policy-Based};
\end{tikzpicture}
\end{document}