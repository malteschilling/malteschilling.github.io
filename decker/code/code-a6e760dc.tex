...
\pagestyle{empty}
  \begin{tikzpicture}
    ...
    \draw[stealth-stealth, line width=0.4mm] (13.85, 2.5) -- (13.15, 2.5);
    \draw[stealth-stealth, line width=0.4mm] (13.5, 2.15) -- (13.5, 2.85);
    % Second from bottom row.
    \draw[stealth-stealth, line width=0.4mm] (10.5, 1.15) -- (10.5, 1.85);
    \draw[stealth-stealth, line width=0.4mm] (10.85, 1.5) -- (10.15, 1.5);
    \draw[stealth-stealth, line width=0.4mm] (11.15, 1.5) -- (11.85, 1.5);
    \draw[stealth-stealth, line width=0.4mm] (11.5, 1.15) -- (11.5, 1.85);
    \draw[stealth-stealth, line width=0.4mm] (12.15, 1.5) -- (12.85, 1.5);
    \draw[stealth-stealth, line width=0.4mm] (12.5, 1.85) -- (12.5, 1.15);
    \draw[stealth-, line width=0.4mm] (13.5, 1.15) -- (13.5, 1.85);
    % Bottom row.
    \draw[stealth-stealth, line width=0.4mm] (10.15, 0.5) -- (10.85, 0.5);
    \draw[stealth-stealth, line width=0.4mm] (10.5, 0.15) -- (10.5, 0.85);
    \draw[stealth-stealth, line width=0.4mm] (11.15, 0.5) -- (11.85, 0.5);
    \draw[stealth-stealth, line width=0.4mm] (12.5, 0.15) -- (12.5, 0.85);
