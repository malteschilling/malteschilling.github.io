...
\pagestyle{empty}
  \begin{tikzpicture}
  \node[draw,rectangle, line width=0.4mm] (r1) at (4, 1) {LR};
  	\node[draw,rectangle,fill,gray!75,scale=1.7] (left_right) at (-1.5, 1) {};
    \node[draw,scale=2/3] (lr) at (-1.5, 1) {\scriptsize LR};
