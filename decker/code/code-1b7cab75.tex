...
\pagestyle{empty}
  \begin{tikzpicture}
    ...
    \node at (1.7, 0.6) {\tiny $5 \lor 0$};
    \node[draw,circle,scale=0.2, fill=black] (al) at (1.5,-0.45) {};
    \node at (1.2, -0.45) {\tiny right};
    \node at (1.7, -0.6) {\tiny $1$};
    ...
    \draw[-, line width=2 mm] (-2.2, 1.5) -- (-0.8, 1.5) -- (-0.8, 0.5) -- (0.8, 0.5) -- (0.8,1.5) -- (2.2,1.5) -- (2.2,-1.5) -- (0.8,-1.5) -- (0.8,-0.5) -- (-0.8,-0.5) -- (-0.8,-1.5) -- (-2.2,-1.5) -- (-2.2,1.5) -- (-1,1.5);  
