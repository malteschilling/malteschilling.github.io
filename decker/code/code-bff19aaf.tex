...
\pagestyle{empty}
  \begin{tikzpicture}[scale=3/4]
    ...
    \node[draw,circle,fill,scale=1/4,blue!50] (one)  at (-3.5, 1.25) {};
    \node[draw,circle,fill,scale=1/4,blue!50] (two)  at (-3, -1) {};
    \node[draw,circle,fill,scale=1/4,blue!50] (three)at (-2.5, 0.85) {};
    \node[draw,circle,fill,scale=1/4,blue!50] (four) at (-2, -2/3) {};
    \node[draw,circle,fill,scale=1/4,blue!50] (five) at (-1.5, 0.35) {};
