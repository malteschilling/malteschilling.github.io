...
\begin{tikzpicture}
  ...
  \node[draw,circle,scale=0.8, fill=black, line width=0.5mm, label=right:{$A'$}] (a_1) at (-1,-3) {};
  \node[draw,circle,scale=0.8, fill=black, line width=0.5mm, label=right:{$A'$}] (a_2) at (0,-3) {};
