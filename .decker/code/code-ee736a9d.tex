...
\pagestyle{empty}
  \begin{tikzpicture}
    ...
    % Top row.
    \draw[stealth-stealth, line width=0.4mm] (6.1, 3.5) -- (6.9, 3.5);
    \draw[stealth-stealth, line width=0.4mm] (6.5, 3.1) -- (6.5, 3.9);
    \draw[stealth-stealth, line width=0.4mm] (7.1, 3.5) -- (7.9, 3.5);
    \draw[stealth-stealth, line width=0.4mm] (7.5, 3.1) -- (7.5, 3.9);
    \draw[stealth-stealth, line width=0.4mm] (8.1, 3.5) -- (8.9, 3.5);
    \draw[stealth-stealth, line width=0.4mm] (8.5, 3.1) -- (8.5, 3.9);
    % Second frop top row.
    \node at (5.25, 2.25) {\large 4};
    \node at (6.25, 2.25) {\large 5};
    \node at (7.25, 2.25) {\large 6};
    \node at (8.25, 2.25) {\large 7};
    % Second from bottom row.
    \node at (5.25, 1.25) {\large 8};
    \node at (6.25, 1.25) {\large 9};
    \node at (7.25, 1.25) {\large 10};
    \node at (8.25, 1.25) {\large 11};
    % Bottom row.
    \node at (5.25, 0.25) {\large 12};
    \node at (6.25, 0.25) {\large 13};
    \node at (7.25, 0.25) {\large 14};
  \end{tikzpicture}
\end{document}